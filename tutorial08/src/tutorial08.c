...
void pwm_init(void) {
    ...
    TCA0.SINGLE.CMP1 = 1018;
    TCA0.SINGLE.CMP0 = 4629;
...
int main(void) {
    ...
    while(1) {
        ...
        result = ADC0.RESULT0; // Read the potentiometer
        TCA0.SINGLE.CMP1BUF = 9259 - ((((uint16_t)result+1)*9259UL)>>8);
        ...
        // 223 = 87.5%, 255 = 100%
        if (result > 224) {
            TCA0.SINGLE.CMP0BUF = 4629; // TCA0.SINGLE.PER/2
            } else {
                TCA0.SINGLE.CMP0BUF = 0;
            }
